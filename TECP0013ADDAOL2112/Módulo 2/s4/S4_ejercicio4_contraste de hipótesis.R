...
# rate es la tasa incremental (crecimiento)
...
z0
# que proviene de una distribución normal estándar 
#aproximadamente.

# Supongamos que estamos interesados en encontrar 
#la región de rechazo 
#(de cola superior) con un nivel de significancia 
#alpha = 0.05, 
#debemos encontrar el valor z_{0.05} 
#que satisface P(Z > z_{0.05}) = 0.05.

(z.05 <- qnorm(p = 0.05, lower.tail = FALSE)) #false porque estamos haciendo una de cola superior
# Como

z0 > z.05
# rechazamos la hipótesis nula

# estamos interesados en contrastar las hipótesis H0: mu = 0.1 vs H1: mu < 0.1 (contraste de cola inferior)
...
#alfa es la probabilidad de tener un error
