...
#con distribución exponencial y 
#parámetro lambda = 2
...
(m1.4 <- rexp(n = 4, rate = 2)) #numero de observaciones generaldas, parámetro aquí es 2
...
ggplot(mdf, aes(media1000.33)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 16)) 
mean(media1000.33); 
1/2 # Media de las 1000 medias y media de la población de la cual vienen las 1000 muestras
