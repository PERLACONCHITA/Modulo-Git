...
# Distribución binomial. La usamos para experimentar

# En `R` para calcular valores de las funciones 
#de probabilidad, distribución 
# o cuantiles de la distribución binomial 
...
dbinom(x = 20, size = 30, prob = 0.2) #de los 30 intentos cual es la probabilidad de que 20 sean águila
...
# Observemos la región que corresponde 
#a esta probabilidad en la siguiente gráfica
